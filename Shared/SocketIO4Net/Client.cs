...
namespace SocketIOClient
{
	...
	public class Client : IDisposable, SocketIOClient.IClient
	{
		...
		/// <summary>
		/// RegistrationManager for object events
		/// </summary>
		protected RegistrationManager registrationManager;  // allow registration of object events (event names) for client actions
		/// <summary>
